...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='calibur.conf'
CONFIGFOLDER='/root/.calibur'
COIN_DAEMON='caliburd'
COIN_CLI='calibur-cli'
COIN_TGZ='https://github.com/caliburcoin/Crypto-Calibur/releases/download/1.1.1/caliburx86-64-linux.zip'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='Calibur'
COIN_PORT=55555 #Updated Port
RPC_PORT=6783
...
printf "Hello,  \n Enter 1 for Install Calibur \n Enter 2 for Update Calibur \n Enter 3 for bootstrap. \n "
read choice
if (($choice == 1 )) 
 then
	cleanup_mess
...
#  wget https://gist.githubusercontent.com/hoserdude/9661c9cdc4b59cf5f001/raw/5972d4d838691c1a1f33fb274f97fa0b403d10bd/doge.txt
  cat dogec.txt
printf "%s\n"
echo "Calibur MN installer Depends Starting"
